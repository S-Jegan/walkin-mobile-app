...
public class WorkModeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        filterItemAdapter = new FilterItemAdapter(getActivity(),filterRestResponse.getWorkmode());
    ...
    public List<FilterCategoryRestResponse> getFilteredWorkMode() {
